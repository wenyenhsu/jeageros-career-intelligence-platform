...
CRAWL_SCHEDULE_SECONDS = int(os.getenv("CRAWL_SCHEDULE_SECONDS", "43200"))
...
SKILL_EMBEDDING_PROVIDER = os.getenv("SKILL_EMBEDDING_PROVIDER", "ollama")
SKILL_EMBEDDING_DIMENSIONS = int(os.getenv("SKILL_EMBEDDING_DIMENSIONS", "1024"))
